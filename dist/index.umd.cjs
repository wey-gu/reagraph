...
(function(global, factory) {
    ...
    return react$1.useGesture(
      {
        ...
        onDrag: ({ event }) => {
          ...
          const nx = (clientX - ((clientRect == null ? void 0 : clientRect.left) ?? 0)) / size.width * 2 - 1;
          const ny = -((clientY - ((clientRect == null ? void 0 : clientRect.top) ?? 0)) / size.height) * 2 + 1;
          mouse2D.set(nx, ny);
  ...
  const Node = ({
    ...
    drei.useCursor(active && !draggingId && onClick !== void 0, "pointer");
    drei.useCursor(
      active && draggable && !isDragging && onClick === void 0,
      "grab"
    );
    drei.useCursor(isDragging, "grabbing");
  ...
  const Edge = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("group", { children: [
      ...
      contextMenu && edgeContextMenus.has(edge.id) && /* @__PURE__ */ jsxRuntime.jsx(drei.Html, { prepend: true, center: true, position: midPoint, children: contextMenu({
        data: edge,
  ...
  const Cluster = ({
    ...
    drei.useCursor(active && onClick !== void 0, "pointer");
    const { pointerOver, pointerOut } = useHoverIntent({
      disabled: disabled2,
      onPointerOver: (event) => {
        setActive(true);
